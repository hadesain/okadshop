gapi.analytics.ready(function() {
   ...
   * element with the ID "embed-api-auth".
   */
   ...
   * element with the id "view-selector".
   */
   ...
   * It will be rendered inside an element with the id "site-traffic".
   */
  ...
  function renderWeekOverWeekChart(ids) {
    ...
    Promise.all([thisWeek, lastWeek]).then(function(results) {
      ...
      new Chart(makeCanvas('week-chart')).Line(data);
      generateLegend('week-legendr', data.datasets);
    });
  }
  ...
  function renderYearOverYearChart(ids) {
    ...
    Promise.all([thisYear, lastYear]).then(function(results) {
      ...
      new Chart(makeCanvas('year-chart')).Bar(data);
  ...
  function renderTopBrowsersChart(ids) {
    ...
    .then(function(response) {
      ...
      new Chart(makeCanvas('navigators-chart')).Doughnut(data);
      generateLegend('navigators-legend', data);
    });
  }
  ...
  function renderTopCountriesChart(ids) {
    ...
    .then(function(response) {
      ...
      new Chart(makeCanvas('countries-chart')).Doughnut(data);
