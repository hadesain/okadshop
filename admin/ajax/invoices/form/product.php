...
if( $id_detail ){
	...
	$row['row'] = '<tr id="'.$id_detail.'">
			      	...
			      	<a href="javascript:;" class="btn btn-default update" title="'.l("Mettre à jour", "admin").'"><i class="fa fa-refresh"></i></a>
			      	<a href="javascript:;" class="btn btn-danger delete" title="'.l("Supprimer ce produit", "admin").'"><i class="fa fa-trash"></i></a>
			      </td>
					</tr>';
