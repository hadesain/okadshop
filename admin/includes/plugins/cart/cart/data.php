...
function DELETE($ID){
	...
	$id = $common->delete('cart', "WHERE id=".$ID );
...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['name']) && !empty($_POST['code']) ){
  ...
  $cart_data = array(
    ...
    'gift_product'           => intval($_POST['gift_product']), 
...
<form class="form-horizontal" method="post" action="">
  <div class="col-sm-12 padding0" style="margin-bottom:10px;border-bottom:1px solid #A5245E;">
    <ul class="nav nav-tabs bg-white">
      <li><a data-toggle="tab" href="#step-1"><span class="number">1</span> <?=l("Informations", "admin");?></a></li>
      <li><a data-toggle="tab" href="#step-2"><span class="number">2</span> <?=l("Conditions", "admin");?></a></li>
      <li><a data-toggle="tab" href="#step-3"><span class="number">3</span> <?=l("Actions", "admin");?></a></li>
    </ul>
  </div>
  ...
  <div class="tab-content col-sm-12 padding0">
    ...
    <div class="tab-pane active" id="step-1">
      <div class="panel panel-default">
        <div class="panel-heading"><?=l("Informations", "admin");?></div>
        <div class="panel-body">

          <div class="form-group">
            <label class="control-label col-sm-3" for="name"><?=l("Nom", "admin");?></label>
            <div class="col-sm-3">
              <input name="name" type="text" value="<?=( isset($cart['name']) ) ? $cart['name'] : '';?>" class="form-control" id="name">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3" for="description"><?=l("Description", "admin");?></label>
            <div class="col-sm-5">
              <textarea name="description" id="description" rows="2" class="form-control"><?=( isset($cart['description']) ) ? $cart['description'] : '';?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3" for="code"><?=l("Code", "admin");?></label>
            <div class="col-sm-3">
              <div class="input-group">
                <input name="code" type="text" value="<?=( isset($cart['code']) ) ? $cart['code'] : '';?>" class="form-control" id="code">
                <span class="input-group-btn">
                  <a href="javascript:gencode(8, '#code');" class="btn btn-default"><i class="fa fa-random"></i> <?=l("Générer", "admin");?></a>
                </span>
              </div>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label"><?=l("État", "admin");?></label>  
            <div class="col-sm-3">
        ...
        <div class="panel-footer">
          <button type="button" class="btn btn-danger" onclick="window.location='?module=cart';"><?=l("Fermer", "admin");?></button>
          <button type="submit" name="<?= (isset($id_cart) && $id_cart > 0) ? 'update' : 'save';?>" class="btn btn-primary pull-right"><?=l("Sauvegarder et rester", "admin");?></button>
        </div><!--/ .panel-footer -->
      </div><!--/ .panel -->
    </div><!--/ #step-1 -->
    ...
    <div class="tab-pane" id="step-2">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="form-group">
            <label class="col-sm-3 control-label" for="id_customer"><?=l("Limiter à un seul client", "admin");?></label>  
            <div class="col-sm-3">
              <select name="id_customer" class="form-control">
                <option value=""><?=l("Sélectionnez un Client", "admin");?></option>
          ...
          <div class="form-group">
            ...
            ?>
            <label class="col-sm-3 control-label"><?=l("Valide", "admin");?></label>  
            <div class="col-sm-3">
              <div class="input-group">
                <span class="input-group-addon"><?=l("Du", "admin");?></span> 
          ...
          <div class="form-group">
            <div class="col-sm-3 col-sm-offset-3">
              <div class="input-group">
                <span class="input-group-addon"><?=l("Au", "admin");?></span> 
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" for="minimum_amount"><?=l("Montant minimum", "admin");?></label>  
            <div class="col-sm-3">
              <div class="input-group">
                ...
                <div class="input-group-addon"><?=l("TTC", "admin");?></div>
              </div>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="quantity"><?=l("Quantité totale disponible", "admin");?></label>  
            <div class="col-sm-3">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" for="quantity_per_user"><?=l("Quantité disponible pour chaque utilisateur", "admin");?></label>  
            <div class="col-sm-3">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?=l("Restrictions", "admin");?></label>  
            <div class="col-sm-8">
              <p class="checkbox">
                <label><input type="checkbox" name="carrier_res" id="carrier_restriction" <?=( isset($cart['carrier_restriction']) && $cart['carrier_restriction'] != "" ) ? 'checked' : '';?>><?=l("Sélection de transporteurs", "admin");?></label>
              ...
              <p class="checkbox">
                <label><input type="checkbox" name="group_res" id="group_restriction" <?=( isset($cart['group_restriction']) && $cart['group_restriction'] != "" ) ? 'checked' : '';?>><?=l("Sélection de groupes de clients", "admin");?>>
              ...
              <p class="checkbox">
                <label><input type="checkbox" name="product_res" id="product_restriction" <?=( isset($cart['product_restriction']) && $cart['product_restriction'] != "" ) ? 'checked' : '';?>><?=l("Sélection de produit", "admin");?></label>
    ...
    <div class="tab-pane" id="step-3">
      <div class="panel panel-default">
        <div class="panel-heading"><?=l("Actions", "admin");?></div>
        <div class="panel-body">
          <div class="form-group">
            <label class="col-sm-3 control-label" ><?=l("Frais de port offerts", "admin");?></label>  
            <div class="col-sm-3">
              <input type="checkbox" name="free_shipping" value="1" <?=( isset($cart['free_shipping']) && $cart['free_shipping'] == "1" ) ? 'checked' : '';?>>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label" for="reduction"><?=l("Appliquer une réduction", "admin");?></label>
            <div class="col-sm-3">
              <div class="input-group">
                ...
                <span class="input-group-addon" style="padding: 0px;border: 0px;">
                  <select name="apply_discount" id="apply_discount" class="form-control" style="width: 70px;">
                    ...
                    <option value="1" <?=(isset($cart['apply_discount']) && $cart['apply_discount'] == "1") ? 'selected' : '';?>><?php echo CURRENCY;?></option>
                  </select>
                </span>
              </div>
            </div>
          ...
          <div class="form-group">
            <label class="control-label col-lg-3"><?=l("Appliquer la réduction à", "admin");?></label>
            <div class="col-lg-7">
              <p class="radio">
                <label for="to_order">
                  ...
                  <?=l("La commande (hors frais de port)", "admin");?>
                </label>
              </p>
              <p class="radio">
              ...
              <p class="radio">
                <label for="to_selection" style="display: inline-block;">
                  ...
                  <?=l("Le(s) produit(s) sélectionné(s)", "admin");?>
                </label>
                <div class="alert alert-info msg hidden" style="width: 350px;margin-top: 10px;"><?=l("Vous devez sélectionner au moins un produit", "admin");?></div>
              </p>
            </div>
            ...
            <div class="form-group <?=( isset($cart['reduction_product']) && $cart['reduction_product'] == "0" ) ? 'hidden' : '';?>" id="reduction_product">
              <div class="col-sm-3 col-sm-offset-3">
                <select name="reduction_product" class="form-control">
                  <option value=""><?=l("Sélectionnez un produit", "admin");?></option>
                  <?php if( !empty($products) ) : ?>
                    <?php foreach ($products as $key => $product) : ?>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label"><?=l("Envoyer un cadeau", "admin");?></label>  
            <div class="col-sm-3">
