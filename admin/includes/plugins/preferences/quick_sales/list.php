...
<div class="top-menu padding0">
  <div class="top-menu-title">
    <h3><i class="fa fa-home"></i> <?=l("Ventes flash", "admin");?></h3>
  </div>
</div><br>

<div class="panel panel-default">
<form class="form-horizontal" id="qs_form" method="post" action="ajax/quick_sales/form.php">
  <div class="panel-heading"><?=l("Ventes flash", "admin");?></div>
  <div class="panel-body">

    <input type="hidden" name="id_qs" value="<?=(isset($id_qs)) ? $id_qs : '0';?>" id="id_qs">
    
    <div class="form-group">
      <label class="control-label col-lg-3"><?=l("Contenu de Ventes flash", "admin");?></label>
      <div class="col-lg-6">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-4">
        <input type="checkbox" name="active" class="active" id="active" value="1" <?=(isset($active) && $active=="1") ? 'checked' : '';?> data-on-text="<?=l("OUI", "admin");?>" data-off-text="<?=l("NON", "admin");?>" />
      </div>
    </div>
