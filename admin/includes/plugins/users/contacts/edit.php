...
<div class="top-menu padding0">
  <div class="top-menu-title">
    <h3><i class="fa fa-plus-circle"></i> <?=l("Ajouter un Contact", "admin");?></h3>
  </div>
</div><br>

<div class="panel panel-default">
<form class="form-horizontal" id="contact_form" method="post" action="ajax/users/contacts/edit.php">
  <div class="panel-heading"><?=l("Contacts", "admin");?></div>
  ...
  <input type="hidden" name="id_contact" value="<?=$ID;?>" id="id_contact">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3" for="name"><?=l("Titre *", "admin");?></label>
      <div class="col-sm-3">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3" for="email"><?=l("Adresse e-mail", "admin");?></label>
      <div class="col-sm-5">
        <input type="text" name="email" id="email" value="<?=$c_data[0]['email'];?>" class="form-control">     
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3" for="save_msg"><?=l("Enregistrer les messages ?", "admin");?></label>
      <div class="col-lg-4">
        <input type="checkbox" name="save_msg" class="active" id="save_msg" value="1" <?=(isset($c_data[0]['save_msg']) && $c_data[0]['save_msg']=="1") ? 'checked' : '';?> data-on-text="<?=l("OUI", "admin");?>" data-off-text="<?=l("NON", "admin");?>" />
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3" for="description"><?=l("Description *", "admin");?></label>
      <div class="col-sm-6">
  ...
  <div class="panel-footer">
    <a href="?module=contacts" class="btn btn-default"><?=l("Fermer", "admin");?></a>
