...
<div class="top-menu padding0">
  <div class="top-menu-title">
    <h3><i class="fa fa-industry"></i> <?=l("Fabricants", "admin");?></h3>
  </div>
  <a href="?module=manufacturers" class="btn btn-primary pull-right"><?=l("Liste des Fabricants", "admin");?></a>
</div><br>

<div class="panel panel-default">
<form class="form-horizontal" id="m_form" method="post" action="ajax/manufacturers/form.php">
  <div class="panel-heading"><?=l("Nouveau Fabricant", "admin");?></div>
  <div class="panel-body">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3"><?=l("Résumé", "admin");?></label>
      <div class="col-lg-6">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3"><?=l("Activer", "admin");?></label>
      <div class="col-lg-4">
        <input type="checkbox" name="active" class="active" id="active" value="1" <?=(isset($m[0]['active']) && $m[0]['active']=="1") ? 'checked' : '';?> data-on-text="<?=l("activé", "admin");?>" data-off-text="<?=l("désactivé", "admin");?>" />
      </div>
    </div>

  </div><!--/ .panel-body -->
  <div class="panel-footer">
    <a href="?module=manufacturers" class="btn btn-default"><?=l("Fermer", "admin");?></a>
