...
global $hooks;
$theme_sections = $hooks->get_theme_sections( themeFolder );
...
<div class="top-menu padding0">
  <div class="top-menu-title">
    <h3><i class="fa fa-puzzle-piece"></i> <?=l("Positions des modules", "admin");?></h3>
  </div>
</div><br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=l("Activer les positions des modules", "admin");?></h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal"><?=l("Terminer", "admin");?></button>
      </div>
    </div>
  </div>
</div>
