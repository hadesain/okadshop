...
<div class="top-menu padding0">
  <div class="top-menu-title">
    <h3><i class="fa fa-credit-card"></i> <?=l("Edition de la Facture", "admin");?>
    <span class="badge badge-default"><?php echo $o['invoice']['reference']; ?></span>
		<span class="badge"><?=l("N°", "admin");?><?php echo sprintf("%06d", $o['invoice']['id']);?></span>
	</h3>
  </div>
  <a href="?module=invoices" class="btn btn-default pull-right"><?=l("Términer", "admin");?></a>
</div><br>
...
<div class="col-sm-12 padding0" style="margin-bottom:10px;border-bottom:1px solid #A5245E;">
	<ul class="nav nav-tabs bg-white">
		...
		<li class="pull-right">
			<a target="_blank" href="../pdf/invoice.php?id_invoice=<?=$o['invoice']['id'];?>&id_customer=<?=$o['invoice']['id_customer'];?>" class="btn"><i class="fa fa-file-pdf-o"></i> <?=l("Apérçu la Facture", "admin");?></a>
		</li>
	</ul>
</div>
	...
	<div class="tab-pane active" id="step-1">
		<div class="panel panel-default">
		    ...
		    <div class="panel-subheading">
					...
					<strong><?=l("Produits dans cette Facture", "admin");?></strong>
				</div>
				...
				<form class="form-horizontal" method="post" action="">
					...
					<tbody>
			            ...
			            <?php endif; ?>
							...
							<td>
								<input type="text" name="payment[transaction_id]" value="" class="form-control" id="transaction_id"  placeholder="<?=l("ID de la transaction", "admin");?>" required>
							</td>
							<td>
								<div class="input-group">
