...
$countries = $os->get_json_file($c_path);
              ...
              <div class="col-sm-3" style="padding:0px;">
                <form action="" id="lang_form" method="post">
                  <select id="default_lang" name="default_lang" class="form-control">
                    ...
                    <option value="it_IT" <?=(isset($_COOKIE['default_lang']) && $_COOKIE['default_lang']=="it_IT") ? 'selected' : '';?>>Italiano</option>
                    <option value="pt_PT" <?=(isset($_COOKIE['default_lang']) && $_COOKIE['default_lang']=="pt_PT") ? 'selected' : '';?>>Portuguese</option>
                    <option value="pl_PL" <?=(isset($_COOKIE['default_lang']) && $_COOKIE['default_lang']=="pl_PL") ? 'selected' : '';?>>Polish</option>
                    <option value="nl_NL" <?=(isset($_COOKIE['default_lang']) && $_COOKIE['default_lang']=="nl_NL") ? 'selected' : '';?>>Dutch</option>
                  </select>
                </form>
              </div><br>
            ...
            <div class="tab-pane" id="database">
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input id="server" name="server" type="text" value="" class="form-control">
                    <sup class="required">*</sup>
                  </div>
                </div><hr>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input id="database" name="database" type="text" value="" class="form-control">
                    <sup class="required">*</sup>
                  </div>
                </div><hr>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input id="user" name="user" type="text" value="" class="form-control">
                    <sup class="required">*</sup>
                  </div>
                </div><hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input id="prefix" name="prefix" type="text" value="os_" class="form-control">
                    <sup class="required">*</sup>
                  </div>
                </div><hr>
                <div class="form-group">
