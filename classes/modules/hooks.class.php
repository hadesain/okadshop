...
class Hooks extends modules
{
	...
	var $modules_infos = array();
	var $hooks_array 	 = array();
	var $modules_path  = MODULES_PATH;//"../../../../../modules/";
