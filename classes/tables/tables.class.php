...
class Tables
{
    ...
    ///extract module name
            ...
            $Rights = array();
            while($this->ROW = $DB->FArray($this->RES))
            {
        ...
        {               
            ...
            foreach($this->select as $Select_e=>$Select_k)
            {
                ...
                elseif(strstr($f,'active')){
                    ...
                    if($f ==1){
                        $sOutput .= '"<i class=\"fa fa-check\" aria-hidden=\"true\" title=\"'. l("activé", "admin") .'\"></i>",';
                        ...
                        $sOutput .= '"<i class=\"fa fa-close\" aria-hidden=\"true\" title=\"'. l("desactivé", "admin") .'\"></i>",';
                    }
                    ...
                    if(file_exists($aRow[$f]))
                    {
                        ...
                        {
                            case '.pdf' : $sOutput .= '"<a href=\"'.$aRow[$f].'\" target=\"_blank\" title=\"'. l("Télécharger le fichier", "admin") .'\"><img class=\"link\" src=\"'.$aRow[$f].'\" width=\"60px\"></a>",';
                                break;
                            case '.jpg' : $sOutput .= '"<a href=\"'.$aRow[$f].'\" target=\"_blank\" title=\"'. l("Télécharger le fichier", "admin") .'\"><img class=\"link\" src=\"'.$aRow[$f].'\" width=\"60px\"></a>",';
                                break;
                            case 'jpeg' : $sOutput .= '"<a href=\"'.$aRow[$f].'\" target=\"_blank\" title=\"'. l("Télécharger le fichier", "admin") .'\"><img class=\"link\" src=\"'.$aRow[$f].'\" width=\"60px\"></a>",';
                                break;
                            case '.png' : $sOutput .= '"<a href=\"'.$aRow[$f].'\" target=\"_blank\" title=\"'. l("Télécharger le fichier", "admin") .'\"><img class=\"link\" src=\"'.$aRow[$f].'\" width=\"60px\"></a>",';
                                break;
                            default : $sOutput .= '"<a href=\"'.$aRow[$f].'\" target=\"_blank\" title=\"'. l("Télécharger le fichier", "admin") .'\">'. l("Télécharger", "admin") .'</a>",';
                        }
                    }else{
                        $sOutput .= '"'.$aRow[$f].'",';
                        //$sOutput .= '"<img class=\"link\" src=\"images/fileerror.png\" title=\"'. l("Fichier introuvable", "admin") .'\">",';
                    }
                                    
                }elseif($f == 'order'){
                    if($count == 1){
                        $sOutput .='"<img name=\"'.$aRow["order"].'\" id=\"'.$this->FID.'\" src=\"images/order_bottom.png\" title=\"'. l("Deplacer en bas", "admin") .'\" class=\"Displace '.$this->table.'\">",';                                  
                    }else if($count == $iTotal){
                        $sOutput .= '"<img name=\"'.$aRow["order"].'\" id=\"'.$this->FID.'\" src=\"images/order_top.png\" title=\"'. l("Deplacer en haut", "admin") .'\" class=\"Displace '.$this->table.'\">",';                           
                    }else{
                        $sOutput .= '"<img name=\"'.$aRow["order"].'\" id=\"'.$this->FID.'\" src=\"images/order_bottom.png\" title=\"'. l("Deplacer en bas", "admin") .'\" class=\"Displace '.$this->table.'\">&nbsp&nbsp'.
                                    '<img name=\"'.$aRow["order"].'\" id=\"'.$this->FID.'\" src=\"images/order_top.png\" title=\"'. l("Deplacer en haut", "admin") .'\" class=\"Displace '.$this->table.'\">",';                            
                    }                 
            ...
            if(count($this->operations) != 0)
            {
                ...
                {
                    $sOutput .= '<a rel=\"facebox\" href=\"?module='.$this->Module.'&action=edit&id='.$aRow[$this->FID].'\" class=\"btn btn-default btn-xs\" title=\"'. l("Editer", "admin") .'\">'. l("Edit", "admin") .'</a>';
                }

                if(in_array('view',$this->operations))
                {
                    $sOutput .= '<a href=\"?module='.$this->Module.'&action=view&id='.$aRow[$this->FID].'\" class=\"btn btn-default btn-xs \"  title=\"'. l("View", "admin") .'\">'. l("View", "admin") .'</a>';
                }
                if(in_array('download',$this->operations))
                {
                    $sOutput .= '<a href=\"?module='.$this->Module.'&action=invoice&id='.$aRow[$this->FID].'\" class=\"btn btn-default btn-xs\" title=\"'. l("Invoice", "admin") .'\">'. l("Invoice", "admin") .'</a>';
                }
                if(in_array('invoice',$this->operations))
                {
                    $sOutput .= '<a href=\"?module='.$this->Module.'&action=invoice&id='.$aRow[$this->FID].'\" class=\"btn btn-default btn-xs\" title=\"'. l("Download", "admin") .'\">'. l("Download", "admin") .'</a>';
                }
                if(in_array('delete',$this->operations) || in_array('DELETE',$this->operations))
                {
                    $sOutput .= '<a href=\"?module='.$this->Module.'&action=delete&id='.$aRow[$this->FID].'\" class=\"btn btn-default btn-xs DELETE\" onclick=\"DeleteElement(\''.WebSite.$this->Module.'\','.$aRow[$this->FID].')\" title=\"'. l("Delete", "admin") .'\">'. l("Delete", "admin") .'</a>';
                }
