  ...
  /*  if ($idquotation = customGET('quotation_edit')) {
	...
	<h1><?= l("Adresses", "artiza");?></h1>
	<ul class="step" id="order_step">
    <li class="step_line"></li>
    <li class="step_done">
      <p class="number">1</p>
      <p class="name"><a href="order.php"><?= l("Résumé", "artiza");?></a></p>
    </li>
  ...
  <div class="addresses">
    <div class="styled-select">
    	<label for="id_address_delivery"><?= l("Choisissez une adresse de livraison :", "artiza");?></label>
    ...
    <p class="checkbox">
      ...
      <label><?= l("Utiliser la même adresse pour la facturation", "artiza");?></label>
    </p>
    ...
    <div class="styled-select" id="adresse_select_invoice">
      <p>
       <a class="button_large" href="<?= WebSite; ?>account/adresse?fromcart=1" title=""><?= l("Ajoutez une nouvelle adresse", "artiza");?>
       </a>
      <p>
      <label for=""><?= l("Choisissez une adresse de facturation  :", "artiza");?></label>
    ...
    <div class="row">
        ...
        <li class="address_title"><?= l("Votre adresse de livraison", "artiza");?></li>
        ...
        <li class="address_update">
          <a href="" title=""  class="update"><?= l("Modifier cette adresse", "artiza");?></a>
          <a href="" title=""  class="delete"> / <?= l("Supprimer", "artiza");?></a></li>
      </ul>
    	</div>
    	<div class="col-sm-6">
    		<ul class="address alternate_item" id="address_invoice">
					<li class="address_title"><?= l("Votre adresse de facturation", "artiza");?></li>
					<li class="address_firstname lastname"></li>
          <li class="address_company"></li>
					<li class="address_address1"></li>
					<li class="address_postcode city"></li>
          ...
          <li class="address_phone"></li>
					<li class="address_mobile"></li>
					<li class="address_update">
            <a href="" title="Mettre à jour" class="update"><?= l("Modifier cette adresse", "artiza");?></a>
            <a href="" title="Supprimer" class="delete"> / <?= l("Supprimer", "artiza");?></a></li>
          </li>
				</ul>
    	</div>
    </div>
    ...
    <p class="address_add submit">
      <a class="button_large" href="<?= WebSite; ?>account/adresse?fromcart=1" title=""><?= l("Ajoutez une nouvelle adresse", "artiza");?></a>
    </p>
  ...
  <form method="POST" action="<?= WebSite ?>cart/livraison">
    <p class="cart_navigation">
      ...
      <input type="submit" name="Submitaddress" value="<?= l("Suivant", "artiza");?>" class="exclusive  pull-right">
      <a class="button_large" href="<?= WebSite;?>cart/" title="<?= l("Continuer mes achats", "artiza");?>">« <?= l("Précédent", "artiza");?></a>
    </p>
  </form>
	 <!--  <?php if (customGET('quotation_edit')): ?>
      <form method="POST" action="<?= WebSite ?>account/quotation">
        <p class="cart_navigation">
          ...
          <input type="submit" name="Submitaddress" value="<?= l("Validé la modification", "artiza");?>" class="exclusive  pull-right">
        </p>
      </form>
    <?php else: ?>
      <form method="POST" action="<?= WebSite ?>cart/livraison">
