  ...
  <!-- Main content start here -->
	<ol class="breadcrumb">
	  ...
	  <li class="active"><?= l("Livraison", "artiza");?></li>
	</ol>

	<h1><?= l("Livraison", "artiza");?></h1>
...
<?php execute_section_hooks('sec_carrierfront'); ?>
  <form method="POST" action="<?= WebSite ?>cart/paiement">
   <div class="order_carrier_content">
    <h3 class="carrier_title">Choisissez votre mode de livraison</h3>
...
<!--     <h3 class="recyclable_title">Emballage recyclé</h3>
  ...
  <p class="cart_navigation">
    ...
    <a class="button_large" href="<?= WebSite;?>cart/adresse/" title="<?= l("Précédent", "artiza");?>">« <?= l("Précédent", "artiza");?></a>
  </p>
</form>
