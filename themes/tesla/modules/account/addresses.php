  ...
  <!-- Main content start here -->
	<ol class="breadcrumb">
	  ...
	  <li class="active"><?=l("Mes adresses", "tesla");?></li>
	</ol>

	<h1><?=l("Mes adresses", "tesla");?></h1>

	<div class="addresses">
    <p><?=l("Choisissez vos adresses de facturation et de livraison. Ces dernières seront présélectionnées lors de vos commandes. Vous pouvez également ajouter d'autres adresses, ce qui est particulièrement intéressant pour envoyer des cadeaux ou recevoir votre commande au bureau.", "tesla");?></p><br>
    <h3><?=l("Vos adresses sont listées ci-dessous :", "tesla");?></h3>
    <p><?=l("Pensez à les tenir à jour si ces dernières venaient à changer.", "tesla");?></p>
    <div class="row">
          ...
          <div class="bloc_adresses">
            <ul class="address item first_item">
              ...
              <li class="address_update">
                <a href="<?= WebSite.'account/adresse?id_address='.$Adresses['id']; ?>" title="Mettre à jour"><?=l("Mettre à jour", "tesla");?></a>
              </li>
              <li class="address_delete">
                <a href="<?= WebSite.'account/addresses?id_delete='.$Adresses['id']; ?>" onclick="return confirm('Êtes-vous sûr ?');" title="Supprimer"><?=l("Supprimer", "tesla");?></a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="address_add">
      <a class="button_large" href="<?= WebSite; ?>account/adresse" title="Ajouter une adresse"><?=l("Ajouter une adresse", "tesla");?></a>
    </div>
  </div>
